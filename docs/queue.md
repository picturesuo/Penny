...
- [ ] Show how a wiki entry becomes a living reasoning map with unresolved gaps and next actions.

## Next
- [ ] Build out stress testing as a separate product lane, not just an implied part of pressure testing.
- [ ] Add concrete stress-test passes for weak evidence, contradictions, risky dependencies, and missing comparisons.
- [ ] Track what Penny already challenged so future stress tests deepen the reasoning instead of repeating themselves.
