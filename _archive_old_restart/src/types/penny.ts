...
export interface SessionState {
  ...
  intentionType: import("@/types/thought-map").SessionIntentionType;
  scopedClaimIds: string[];
  timeBudgetMinutes: number | null;
  startedAt: Date;
  endedAt: Date | null;
  actualDurationMinutes: number | null;
  sessionEvents: import("@/types/thought-map").SessionEvent[];
  closingRitual: import("@/types/thought-map").ClosingRitual | null;
  sessionSummary: import("@/types/thought-map").SessionSummary | null;
