...
- Browser e2e: `yc-recording.spec.cjs`, `brain-first.spec.cjs`, and `learn-understanding-tour.spec.cjs` passed together, 3 tests in 5.9s; the Create export path asserts visible `Copy prompt` and `Download .md` actions.
