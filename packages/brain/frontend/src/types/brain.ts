...
export interface CheckProjectNode {
  id: string;
  kind: CheckNodeKind;
  title: string;
  body: string;
...
export interface CheckProjectEdge {
  id: string;
  fromNodeId: string;
  toNodeId: string;
...
export interface CheckProjectGraph {
  id: string;
  northStar: string;
...
export interface CheckWorkSprint {
  prompt: string;
  steps: string[];
  commitment: string;
}

export interface CheckBreakthrough {
  id: string;
  title: string;
  summary: string;
...
export interface CheckSynthesis {
  whatChanged: string[];
...
export interface CheckSavedBrainObject {
  id: string;
...
export interface CheckSourceMaterialInput {
  kind: "text" | "pdf" | "slides" | "document";
  fileName?: string;
  extractedText: string;
}

export interface CheckCreateSessionInput {
  rawText?: string;
  projectDescription?: string;
  sourceMaterial?: CheckSourceMaterialInput;
}

export interface CheckCommitInput {
  commitment: string;
  stance?: CheckCommitStance;
  recommendationId?: string | null;
}

export interface CheckSprintInput {
  sprintText?: string;
  outcome?: string;
}

export interface CheckAddNodeInput {
  kind: CheckNodeKind;
  title: string;
  body?: string;
}
...
export interface CheckCycleResponse {
  data: {
    session: CheckSession;
    cycle: CheckCycle;
    reusedActiveCycle?: boolean;
  };
}

export interface CheckCommitResponse {
  data: {
    session: CheckSession;
    cycle: CheckCycle;
    breakthrough: CheckBreakthrough | null;
  };
}

export interface CheckSprintResponse {
  data: {
    session: CheckSession;
    cycle: CheckCycle;
    synthesis: CheckSynthesis;
  };
}
...
export interface CheckSaveToBrainResponse {
  data: {
    session: CheckSession;
    savedObject: CheckSavedBrainObject;
  };
}
