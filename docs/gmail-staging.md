...
- Semantic search response proving synced Penny memory retrieval, safe result shape, message/thread/source refs, Brain memory refs, snippets, grounded/inferred labels, score reasons, selected-source ref matches, and no raw numeric score in normal UI.
