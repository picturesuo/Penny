...
Remaining non-demo work: production auth/rate limiting/Postgres, real connector proof, backend-derived non-demo Canvas, richer profile-review history, and deeper Brain note/document seeding.
